...
win.title = win.g1.add('statictext',undefined,'AI Processor 4');
win.title.helpTip='Edited from a script by Paul Riggott';
...
win.g10.et1 = win.g10.add('edittext',undefined,'72');
...
win.g30.et1 = win.g30.add('edittext',undefined,'/Users/lccreative04/Documents/');
...
win.g30.bu1.onClick=function(){
  if(win.g25.dd1.selection.index == 0){
      topLevelFolder = File.openDialog('Please select Illustrator file.','AI File:*.ai'); 	
  }else{
...
win.g40.et1 = win.g40.add('edittext',undefined,'/Users/lccreative04/Documents/export');
...
win.g100.cb1 = win.g100.add('checkbox',undefined,'Seq No:');
win.g100.cb1.value = 0;
var numbers =[0,1,2,3,4,5];
win.g100.cb1.helpTip='Start sequence number';
...
win.g150.et1 = win.g150.add('edittext',undefined,'Slide ');
...
win.g150.cb1 = win.g150.add('checkbox',undefined,'Job number');
win.g150.cb1.value = 1;
win.g150.et2 = win.g150.add('edittext',undefined,'');
win.g150.et2.preferredSize=[120,20];
win.g50.cb1.onClick=function(){
    if(win.g50.cb1.value){
        win.g50.dd1.enabled=true;
        win.g50.dd2.enabled=true;
...
win.g150.cb1.onClick = function(){
    if(win.g150.cb1.value){
        win.g150.et2.enabled=true;
        }else{
            win.g150.et2.enabled=false;
            }
};
...
z.font = ScriptUI.newFont('Georgia','BOLD',18);
...
if(win.g25.dd1.selection.index == 1){//folder of pdfs
    ...
    var fileList = folders[0].getFiles("*.ai");
...
for(var z in folders){
    var fileList = folders[z].getFiles("*.ai");
...
if(win.g150.cb1.value == true && win.g100.cb1.value == true){
    var label = (win.g150.et2.text.toString() + "-" + zeroPad(fileCount,seqLength).toString());  
    labelSlide(label); 
   }
if(win.g150.cb1.value == true && win.g100.cb1.value == false){
    var NameIndex = Name.slice(6, Name.length);
    var label = (win.g150.et2.text.toString() + "-" + NameIndex);  
    labelSlide(label); 
   }
//Save files.....
...
/****************************************** F U N C T I O N S ********************************************/
function labelSlide(label){
	var docRef = activeDocument;
	var myLayerRef = docRef.artLayers.add();
	myLayerRef.kind = LayerKind.TEXT;
	myLayerRef.name = "Filename";
    var myTextRef = myLayerRef.textItem;
	myTextRef.contents = label;	
       textColor = new SolidColor();
       textColor.rgb.red = 150;
       textColor.rgb.green = 150;
       textColor.rgb.blue = 150;
       myTextRef.color = textColor;
       //myLayerRef.blendMode = BlendMode.EXCLUSION;
       myTextRef.antiAliasMethod = AntiAlias.STRONG;   
       myTextRef.justification = Justification.RIGHT;		
       myTextRef.position = new Array(2556,1434);
	   myTextRef.size = 12;
};
